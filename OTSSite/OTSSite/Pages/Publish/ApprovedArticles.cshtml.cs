...
{
    public class ApprovedArticlesModel : PageModel
    {
        private readonly IRepository<Article> _articleRepository;
        private readonly UserManager<ApplicationIdentityUser> _userManager;

        public List<ArticleStatusViewModel> ApprovedArticleViewModels { get; set; }

        public ApprovedArticlesModel(
        ...
        {
            var articlesFromEntity = _articleRepository.GetAll();
            ApprovedArticleViewModels = new List<ArticleStatusViewModel>();
            foreach (var a in articlesFromEntity)
            {
                ...
                ApprovedArticleViewModels.Add(articlePendingVM);
            }
            return Page();
        }
    }
